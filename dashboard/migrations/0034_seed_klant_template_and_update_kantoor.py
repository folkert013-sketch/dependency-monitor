        ...
        <tr>
          <td style="background-color:#eef2ff;padding:16px 24px;border-bottom:1px solid #e0e7ff;">
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                <td>
                  <p style="margin:0 0 4px;font-size:17px;font-weight:700;color:#1a1a2e;">WhatsApp AI Chat &#8212; Cockpit</p>
                </td>
            ...
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td style="padding:6px 0;color:#374151;font-size:14px;line-height:1.6;">
                  Verkoopfactuur aanmaken en <strong>direct versturen</strong>
                </td>
              </tr>
              <tr>
                <td style="padding:6px 0;vertical-align:top;width:24px;color:#4f46e5;font-size:13px;">&#10003;</td>
  ...
  <tr>
    <td style="padding:0 40px 12px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="border:1px solid #e0e7ff;border-radius:12px;overflow:hidden;">
        <tr>
          <td style="background-color:#eef2ff;padding:16px 24px;border-bottom:1px solid #e0e7ff;">
            <p style="margin:0;font-size:17px;font-weight:700;color:#1a1a2e;">Automatische factuurverwerking</p>
          </td>
        </tr>
        <tr>
          <td style="padding:20px 24px;">
  ...
  <tr>
    <td style="padding:0 40px 24px;">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background-color:#f8fafc;border-radius:12px;overflow:hidden;">
        <tr>
          <td style="padding:20px 24px;">
            <p style="margin:0 0 8px;font-size:15px;font-weight:700;color:#1a1a2e;">Wat u krijgt</p>
            <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
              <tr>
  ...
  <tr>
    <td style="padding:0 40px 8px;" align="center">
      <p style="margin:0 0 16px;color:#374151;font-size:15px;line-height:1.7;text-align:left;">
        Ik laat het u graag zien. Ontdek wat AI-ge&#239;ntegreerd boekhouden
        voor {bedrijfsnaam} kan betekenen.
      </p>
      <table role="presentation" cellpadding="0" cellspacing="0">
        <tr>
          <td style="background-color:#4f46e5;border-radius:8px;">
            <a href="https://www.fenofin.nl/propositie/klant/?utm_source=email&amp;utm_medium=outreach&amp;utm_campaign=klant-mrt2026"
...
Bekijk de volledige propositie: https://www.fenofin.nl/propositie/klant/?utm_source=email&utm_medium=outreach&utm_campaign=klant-mrt2026

Met vriendelijke groet,
Folkert Feenstra
FenoFin B.V. | Zuidlaren
f.feenstra@fenofin.nl | www.fenofin.nl | WhatsApp | LinkedIn"""


# ---------------------------------------------------------------------------
# Kantoor template — updated to light indigo theme
# ---------------------------------------------------------------------------
...
def seed_klant_template(apps, schema_editor):
    ...
    category, _ = TemplateCategory.objects.get_or_create(
        slug="outreach",
        defaults={"name": "Outreach", "order": 0},
    )
    ...
    ResponseTemplate.objects.update_or_create(
        ...
        defaults={
            "name": "Klant (ZZP/DGA)",
            "category": category,
            "subject": "FenoFin \u2014 AI-ge\u00efntegreerd boekhouden voor {bedrijfsnaam}",
            "body": KLANT_BODY,
            "html_template": KLANT_HTML,
            "order": 10,
        },
    )
...
def reverse_seed(apps, schema_editor):
    ResponseTemplate = apps.get_model("dashboard", "ResponseTemplate")
    ResponseTemplate.objects.filter(slug="klant-zzp-dga").delete()


class Migration(migrations.Migration):

    dependencies = [
        ("dashboard", "0033_update_kantoor_template_v2"),
    ]

    operations = [
        migrations.RunPython(seed_klant_template, reverse_seed),
